...
export default function Projects() {
    ...
    const projects = [
        ...
        },
        {
            title: "Chat Bot",
            tags: ["MERN", "Gemini"],
            desc: "A chatbot for special organizaion who is able to answer organizaion related questions.",
        ...
        },
        {
            title: "Telegram Bot",
            tags: ["MERN"],
            desc: "A Gemini integrated telegram bot.",
            img: "/assets/images/tegbot.jpg",
            live: "#",
            github: "#",
        },
        {
