            ...
            <div className="w-[100%] md:w-[50%] h-[100%] flex items-center">
                <div className='w-[100%] h-[70%]  md:ps-[10rem]'>
                    ...
                    <div className='mt-5 grid place-content-center'>
                        <button className='bg-yellow-500 hover:bg-yellow-400 font-semibold flex items-center justify-center gap-2 px-3 py-2 rounded-md'>Download CV <CgSoftwareDownload className='text-2xl' /></button>
                    </div>
                </div>
            </div>
