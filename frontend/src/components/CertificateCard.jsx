...
function CertificateCard({ image, title, link }) {
    ...
    return (
        ...
        >
            ...
            <div className='mt-5'>
                <button className='text-white menuBtn px-3 py-2 rounded-md font-semibold flex items-center justify-center gap-2' onClick={() => location.href = link}>View Certificate<FaArrowUpRightFromSquare className='text-xl' /></button>
            </div>
        </motion.div>
    )
}
