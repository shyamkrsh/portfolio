    ...
    return (
        <div className='projectCard bg-slate-700 rounded-md w-[90%] py-3 flex items-center flex-col cursor-pointer  m-auto'>
            ...
            <div className='mt-3 flex items-center gap-5'>
                <button className='' onClick={() => location.href=link}><FaGithub className='text-3xl' /></button>
                <button className='' onClick={() => location.href=link}><FaArrowUpRightFromSquare className='text-2xl' /></button>
            </div>
        </div>
    )
}
